...
def accrued_interest(issue_date:str, settlement_date:str, rate:float, par:float, frequency:int=1, basis:int=0):
    try:
        accr_int = functions.accrint(issue_date,settlement_date,rate,par,frequency,basis)
        return {
